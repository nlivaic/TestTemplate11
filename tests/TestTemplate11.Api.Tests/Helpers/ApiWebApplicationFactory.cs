        ...
        IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureTestServices(services =>
            {
                ...
                services.Remove(services.SingleOrDefault(d => d.ServiceType == typeof(DbContextOptions<TestTemplate11DbContext>)));
                ...
                var ctx = scopedServices.GetRequiredService<TestTemplate11DbContext>();
        ...
        public TestTemplate11DbContext CreateDbContext(ITestOutputHelper testOutput = null)
        {
        ...
        {
            private readonly DbContextOptions<TestTemplate11DbContext> _options;
            ...
            {
                _options = new DbContextOptionsBuilder<TestTemplate11DbContext>()
            ...
            public TestTemplate11DbContext BuildContext() =>
                new(_options);
        }
    }
}
