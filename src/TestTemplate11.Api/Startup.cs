...
using TestTemplate11.Api.Helpers;
using TestTemplate11.Api.Middlewares;
using TestTemplate11.Application;
using TestTemplate11.Core;
using TestTemplate11.Data;

namespace TestTemplate11.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                var sqlConnectionStringBuilder = new SqlConnectionStringBuilder(_configuration["TestTemplate11DbConnection"] ?? string.Empty);
            ...
            services.AddSwaggerGen(setupAction =>
            {
                ...
                setupAction.SwaggerDoc(
                    "TestTemplate11OpenAPISpecification",
                    new OpenApiInfo
                    {
                        Title = "TestTemplate11 API",
                        Version = "v1",
                        Description = "This API allows access to TestTemplate11.",
                ...
                setupAction.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestTemplate11.Api.xml"));
            });
            ...
            services.AddCors(o => o.AddPolicy("TestTemplate11Client", builder =>
            {
            ...
            services.AddTestTemplate11ApplicationHandlers();
            ...
            services
                .AddHealthChecks()
                .AddDbContextCheck<TestTemplate11DbContext>();
        }
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            //    app.UseHsts();
            // }
            app.UseCors("TestTemplate11Client");
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/TestTemplate11OpenAPISpecification/swagger.json", "TestTemplate11 API");
